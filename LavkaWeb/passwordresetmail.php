...
<html lang="ru">
    ...
    <ul class="menu">
            ...
            <li>
                <h1 style="text-align: center; margin-top: 30px; margin-left: 15px; margin-right: 15px; margin-bottom: 15px; font-size: 32px">Сброс пароля</h1>
            </li>
        </ul>
        <div class="teachers">
                    ...
                    <?php
                        ...
                        if ($user['email'] != '' && $_GET['email'] == '') {
                            ...
                            if( !$mail->send() ) {
                                ...
                                echo '<p style="margin-bottom: 10px; font-size: 18px">Письмо для сброса пароля было отправлено на вашу почту!</p>';
                            }
                        } else {
                            echo '
                            <p style="margin-bottom: 10px; font-size: 18px">Для сброса пароля вам на почту будет прислано письмо c дальнейшими инструкциями. Пожалуйста, введите ваш логин.</p>
                            <input type="text" class="form-control" name="login" id="login" placeholder="Введите логин" value="' . $_GET['email'] . '">
        ...
        <script src="js/passwordresetmail.js?<?php echo time();?>"></script>
    </body>
</html>